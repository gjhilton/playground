...
class RenderingParams: ObservableObject {
    ...
    @Published var backgroundPassColor: Color = Color(red: 0.2, green: 0.2, blue: 0.8)
    @Published var foregroundPassColor: Color = .black
    @Published var backgroundPassOpacity: Float = 0.8
    @Published var foregroundPassOpacity: Float = 0.4
}
