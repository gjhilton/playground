...
class SettingsManager {
    ...
    private static let defaultSettingsJSON = """
    {
      ...
      "background": {
        ...
        "opacity": 1.0,
        "dotTypes": {"central": true, "large": true, "medium": true, "small": true}
      },
      "foreground": {
        "enabled": true,
        "color": {"r": 0.3, "g": 0.5, "b": 0.8},
        "opacity": 0.6,
        "dotTypes": {"central": false, "large": true, "medium": true, "small": false}
      },
      "dotParams": {
        "central": {"radiusMin": 0.15, "radiusMax": 0.3},
        "large": {"count": 25, "radiusMin": 0.02, "radiusMax": 0.08, "maxDistance": 0.15},
        "medium": {"count": 40, "radiusMin": 0.005, "radiusMax": 0.025, "maxDistance": 0.2},
        "small": {"count": 80, "radiusMin": 0.001, "radiusMax": 0.008, "maxDistance": 0.35}
      },
      "rendering": {
    ...
    static func createCentralDotParams() -> CentralDotParams {
        ...
        params.radiusMin = defaultSettings.dotParams.central.radiusMin
        params.radiusMax = defaultSettings.dotParams.central.radiusMax
        return params
    }
    
    static func createLargeDotParams() -> LargeDotParams {
        let params = LargeDotParams()
        params.count = defaultSettings.dotParams.large.count
        params.radiusMin = defaultSettings.dotParams.large.radiusMin
        params.radiusMax = defaultSettings.dotParams.large.radiusMax
        params.maxDistance = defaultSettings.dotParams.large.maxDistance
        return params
    }
    
    static func createMediumDotParams() -> MediumDotParams {
        let params = MediumDotParams()
        params.count = defaultSettings.dotParams.medium.count
        params.radiusMin = defaultSettings.dotParams.medium.radiusMin
        params.radiusMax = defaultSettings.dotParams.medium.radiusMax
        params.maxDistance = defaultSettings.dotParams.medium.maxDistance
        return params
    }
    
    static func createSmallDotParams() -> SmallDotParams {
        let params = SmallDotParams()
        params.count = defaultSettings.dotParams.small.count
        params.radiusMin = defaultSettings.dotParams.small.radiusMin
        params.radiusMax = defaultSettings.dotParams.small.radiusMax
        params.maxDistance = defaultSettings.dotParams.small.maxDistance
        return params
    }
    ...
    static func createRenderingParams() -> RenderingParams {
        ...
        params.useSeededRNG = settings.rendering.useSeededRNG
        params.rngSeed = settings.rendering.rngSeed
        
        params.backgroundPassEnabled = settings.background.enabled
        params.backgroundPassColor = colorFromRGB(settings.background.color)
        params.backgroundPassOpacity = settings.background.opacity
        params.backgroundCentralDot = settings.background.dotTypes.central
        params.backgroundLargeDots = settings.background.dotTypes.large
        params.backgroundMediumDots = settings.background.dotTypes.medium
        params.backgroundSmallDots = settings.background.dotTypes.small
        
        params.foregroundPassEnabled = settings.foreground.enabled
        params.foregroundPassColor = colorFromRGB(settings.foreground.color)
        params.foregroundPassOpacity = settings.foreground.opacity
        params.foregroundCentralDot = settings.foreground.dotTypes.central
        params.foregroundLargeDots = settings.foreground.dotTypes.large
        params.foregroundMediumDots = settings.foreground.dotTypes.medium
        params.foregroundSmallDots = settings.foreground.dotTypes.small
    ...
    static func exportSettings(from viewModel: SplatterViewModel) -> String {
        let settings = SplatterSettings(
            version: "3.10",
            background: SplatterSettings.PassSettings(
                ...
                dotTypes: SplatterSettings.DotTypeSettings(
            ...
            foreground: SplatterSettings.PassSettings(
            ...
            dotParams: SplatterSettings.DotParameters(
    ...
    private static func applySettings(_ settings: SplatterSettings, to viewModel: SplatterViewModel) {
        ...
        viewModel.rendering.backgroundPassEnabled = settings.background.enabled
        viewModel.rendering.backgroundPassColor = colorFromRGB(settings.background.color)
        viewModel.rendering.backgroundPassOpacity = settings.background.opacity
        viewModel.rendering.backgroundCentralDot = settings.background.dotTypes.central
        viewModel.rendering.backgroundLargeDots = settings.background.dotTypes.large
        viewModel.rendering.backgroundMediumDots = settings.background.dotTypes.medium
        viewModel.rendering.backgroundSmallDots = settings.background.dotTypes.small
        
        viewModel.rendering.foregroundPassEnabled = settings.foreground.enabled
        viewModel.rendering.foregroundPassColor = colorFromRGB(settings.foreground.color)
        viewModel.rendering.foregroundPassOpacity = settings.foreground.opacity
        viewModel.rendering.foregroundCentralDot = settings.foreground.dotTypes.central
        viewModel.rendering.foregroundLargeDots = settings.foreground.dotTypes.large
        viewModel.rendering.foregroundMediumDots = settings.foreground.dotTypes.medium
        viewModel.rendering.foregroundSmallDots = settings.foreground.dotTypes.small
        
        viewModel.rendering.influenceThreshold = settings.rendering.influenceThreshold
        viewModel.rendering.useSeededRNG = settings.rendering.useSeededRNG
        viewModel.rendering.rngSeed = settings.rendering.rngSeed
        
        // Apply dot parameters
        viewModel.centralDot.radiusMin = settings.dotParams.central.radiusMin
        viewModel.centralDot.radiusMax = settings.dotParams.central.radiusMax
        
        viewModel.largeDots.count = settings.dotParams.large.count
        viewModel.largeDots.radiusMin = settings.dotParams.large.radiusMin
        viewModel.largeDots.radiusMax = settings.dotParams.large.radiusMax
        viewModel.largeDots.maxDistance = settings.dotParams.large.maxDistance
        
        viewModel.mediumDots.count = settings.dotParams.medium.count
        viewModel.mediumDots.radiusMin = settings.dotParams.medium.radiusMin
        viewModel.mediumDots.radiusMax = settings.dotParams.medium.radiusMax
        viewModel.mediumDots.maxDistance = settings.dotParams.medium.maxDistance
        
        viewModel.smallDots.count = settings.dotParams.small.count
        viewModel.smallDots.radiusMin = settings.dotParams.small.radiusMin
        viewModel.smallDots.radiusMax = settings.dotParams.small.radiusMax
        viewModel.smallDots.maxDistance = settings.dotParams.small.maxDistance
    }
    
    // MARK: - Utility Methods
    
    private static func colorFromRGB(_ rgb: SplatterSettings.ColorRGB) -> Color {
        Color(red: rgb.r, green: rgb.g, blue: rgb.b)
    }
    
    private static func rgbFromColor(_ color: Color) -> SplatterSettings.ColorRGB {
        let simd = color.simd3
        return SplatterSettings.ColorRGB(
            r: Double(simd.x),
            g: Double(simd.y), 
            b: Double(simd.z)
        )
